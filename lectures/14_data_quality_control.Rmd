...
setup_presentation("data_quality_control")
```
...
```{r height_distribution, echo = FALSE, fig.width = 8, fig.height = 5, out.width = "100%"}
height_df <- bind_rows(
  tibble(sex = "female",
...
```{r height_distribution_sex, echo = FALSE, fig.width = 8, fig.height = 5, out.width = "100%"}
ggplot(height_df) +
